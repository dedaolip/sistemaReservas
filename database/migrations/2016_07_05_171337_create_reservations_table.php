...
class CreateReservationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('reservations', function (Blueprint $table) {
            ...
            $table->integer('class_id')->unsigned();   //id da turma
            $table->integer('classroom_id')->unsigned();   //id da sala de aula
            $table->integer('projector_id')->unsigned();   //id do projetor
            $table->integer('notebook_id')->unsigned();   //id do notebook
            $table->integer('speaker_id')->unsigned();   //id da caixa de som
            $table->date('date');//data da reserva
            $table->string('period', 20);//periodo da reserva
            $table->string('block', 20);//bloco de aula da reserva
            $table->timestamps();
